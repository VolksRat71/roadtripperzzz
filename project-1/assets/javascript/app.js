...
$(document).ready(function () {
    ...
    $(document).on("click", "#loadButton", function () {
        ...
        function weatherReport() {
            ...
            $.ajax({
                ...
                for(var i=0; i<response.daily.data.length; i++){
                    // if (response.daily.data[i].icon == "partly-cloudy-day"){
                    //     $("#weatherStuff").append("<img src= '../images/weather/SVG/Cloud-Download.svg'>")
                    // }
        ...
        var renderVacation= function(){
            ...
            $("#cameron").attr("src","https://www.google.com/maps/embed/v1/directions?key=AIzaSyD-_N_JbKdFWR_zfJ_3RlDbIKs2pIY0-Nw&origin="+userCity+","+userState+"&destination="+randomResult.place+",Oregon");
...
weatherReport();
    ...
    var locations = [
        ...
        //     coordinates: "44.5778669,-121.4218349",
        //     terrain: "Desert",
        ...
        //     coordinates: "45°20′00,-117°00′05",
        //     terrain: "Forest",
